...
Gentellela管理是使用Bootstrap的免费管理模板。
这个模板使用默认的Bootstrap3风格与各种强大的jQuery插件和工具创建一个强大的框架，创建管理面板或后台仪表盘。
主题使用一些库包括图表、日历、表单验证、界面风格、导航菜单、文本表单、范围日期、上传区、表单自动完成、滑动条、进度条、通知和更多。

我很想看你如何使用这个极好的管理模板. You can notify us about your site, app or service by tweeting to [@colorlib](https://twitter.com/colorlib). Once the list will grown long enough we will write a post similar to [this](https://colorlib.com/wp/avada-theme-examples/) to showcase the best examples.
